package com.moon.ancientpoetry.common.spider.Parse;

import com.moon.ancientpoetry.common.enumeration.Dynasty;
import com.moon.ancientpoetry.common.po.Author;
import com.moon.ancientpoetry.common.spider.Dao.AuthorDao;
...
public class FileParse3 {
    public static void main(String[] args) {
        ...
        String str = null;
        try {
            str = FileUtil.readTxtFile("D:\\project\\idea_project\\ancient-poetry\\ancient-poetry-common\\src\\main\\resources\\author_era_yuandai.txt");
        } catch (IOException e) {
            e.printStackTrace();
        }

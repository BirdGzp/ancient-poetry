...
public class EraAuthorSpider2 {
...

    {
        try {
            writeToFile = new WriteToFile(
                    "D:\\project\\idea_project\\ancient-poetry\\ancient-poetry-common\\src\\main\\resources\\author_era_urls2.txt");
    ...
    public int spiderUrl(String url){
        ...
        try {
            ...
            for (int j = 0; j < authorNames.size(); j++) {
                ...
                writeToFile.writeDataToFile("明代 #" + temp + "\r\n");
            }
    ...
    public static void main(String[] args) {
        ...
        EraAuthorSpider2 eraAuthorSpider = new EraAuthorSpider2();
        for (int i = 1; i <= 1000; i++) {
            eraAuthorSpider.spiderUrl("https://so.gushiwen.org/authors/Default.aspx?p=" + i + "&c=%E6%98%8E%E4%BB%A3");
        }

...
public interface AncientWordTranslateFeignService {
    ...
    @RequestMapping(value = "/list/article_id/{articleId}/{pageNum}/{pageSize}", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/list/sentence/{sentenceId}/{pageNum}/{pageSize}", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/list/word/{wordId}/{pageNum}/{pageSize}", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/get/{translateByWordId}", method = RequestMethod.POST)
    String listAncientWordTranslateByWordId(
